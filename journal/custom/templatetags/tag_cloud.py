...
def do_cloud():
    " returns a cloud "
    story_list = [tag for tag in Tag.objects.cloud_for_model(Story, steps=3, distribution=LINEAR, filters=None, min_count=None)]
    entry_list = [tag for tag in Tag.objects.cloud_for_model(Entry, steps=3, distribution=LINEAR, filters=None, min_count=None)]
    video_list = [tag for tag in Tag.objects.cloud_for_model(Video, steps=2, distribution=LINEAR, filters=None, min_count=None)]
