...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('galleries_gallery', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, db_index=True), keep_default=False)

        # Adding field 'Gallery.pub_date'
        db.add_column('galleries_gallery', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2011, 6, 21)), keep_default=False)

        # Adding field 'Gallery.description'
        db.add_column('galleries_gallery', 'description', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Changing field 'Gallery.story'
        db.alter_column('galleries_gallery', 'story_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stories.Story'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'Gallery.slug'
        db.delete_column('galleries_gallery', 'slug')

        # Deleting field 'Gallery.pub_date'
        db.delete_column('galleries_gallery', 'pub_date')

        # Deleting field 'Gallery.description'
        db.delete_column('galleries_gallery', 'description')

        # Changing field 'Gallery.story'
        db.alter_column('galleries_gallery', 'story_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['stories.Story']))
    ...
    models = {
        ...
        'stories.photo': {
            ...
            'creation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 21)'}),
        ...
        'stories.story': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 21, 0, 25, 7, 743013)', 'unique': 'True'}),
