...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PhotosPageOptions'
        db.create_table('galleries_photospageoptions', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='Photos Page Layout', max_length=30)),
        ))
        db.send_create_signal('galleries', ['PhotosPageOptions'])


    def backwards(self, orm):
        
        # Deleting model 'PhotosPageOptions'
        db.delete_table('galleries_photospageoptions')
    ...
    models = {
        ...
        'stories.story': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 13, 20, 23, 22, 248867)', 'unique': 'True'}),
