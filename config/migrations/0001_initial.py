...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('config_siteconfig', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('featured_tags', self.gf('tagging.fields.TagField')()),
            ('announcement_head', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('announcement_body', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('featured_video', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['video.Video'], null=True, blank=True)),
        ))
        db.send_create_signal('config', ['SiteConfig'])

        # Adding model 'FeaturedStory'
        db.create_table('config_featuredstory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('story', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stories.Story'])),
            ('config', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['config.SiteConfig'])),
            ('orig_photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('story_order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, unique=True)),
        ))
        db.send_create_signal('config', ['FeaturedStory'])


    def backwards(self, orm):
        
        # Deleting model 'SiteConfig'
        db.delete_table('config_siteconfig')

        # Deleting model 'FeaturedStory'
        db.delete_table('config_featuredstory')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 4, 22, 20, 44, 366656)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 4, 22, 20, 44, 366533)'}),
        ...
        'config.featuredstory': {
            ...
            'config': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['config.SiteConfig']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'story_order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'unique': 'True'})
        },
        'config.siteconfig': {
            'Meta': {'object_name': 'SiteConfig'},
            'announcement_body': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'announcement_head': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'featured_tags': ('tagging.fields.TagField', [], {}),
            'featured_video': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['video.Video']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
