...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Gallery.story_old'
        db.delete_column(u'galleries_gallery', 'story_old_id')


    def backwards(self, orm):
        # Adding field 'Gallery.story_old'
        db.add_column(u'galleries_gallery', 'story_old',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stories.Story'], null=True, blank=True),
                      keep_default=False)
