...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Gallery.pub_date'
        db.alter_column('galleries_gallery', 'pub_date', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Changing field 'Gallery.pub_date'
        db.alter_column('galleries_gallery', 'pub_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'stories.story': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 21, 1, 1, 24, 356964)', 'unique': 'True'}),
