...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Story.section_order'
        db.alter_column('stories_story', 'section_order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Story.section_order'
        db.alter_column('stories_story', 'section_order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=''))
    ...
    models = {
        ...
        'polls.poll': {
            ...
            'close_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 6, 20, 47, 29, 730638)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'stories.photo': {
            ...
            'creation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 30)'}),
        ...
        'structure.frontconfig': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 30, 20, 47, 29, 944011)'}),
