...
MEDIA_ROOT = '/home/journal/webapps/media/'
...
TEMPLATE_DIRS = (
	...
	"/home/journal/webapps/journal/templates/"
)
...
STATIC_ROOT = '/home/journal/webapps/media/static/'
...
STATICFILES_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/journal/webapps/journal/templates/static/',
)

AKISMET_API_KEY = 'a749fbcef622'

HAYSTACK_XAPIAN_PATH = '/home/journal/webapps/xapian'
