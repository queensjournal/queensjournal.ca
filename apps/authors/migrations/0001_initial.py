...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table(u'structure_headshot', u'authors_headshot')

        db.rename_table(u'structure_authorrole', u'authors_authorrole')

        db.rename_table(u'structure_author', u'authors_author')
    ...
    models = {
        ...
        u'authors.authorrole': {
            'Meta': {'ordering': "['-start_date']", 'object_name': 'AuthorRole'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['authors.Author']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
