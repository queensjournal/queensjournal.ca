...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('config_featuredstory', (
            ...
            ('story_order', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('config', ['FeaturedStory'])

        # Changing field 'SiteConfig.featured_video'
        db.alter_column('config_siteconfig', 'featured_video_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['video.Video'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SiteConfig.featured_video'
        db.alter_column('config_siteconfig', 'featured_video_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['video.Video']))
    ...
    models = {
        ...
        'config.featuredstory': {
            ...
            'story_order': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        'config.siteconfig': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sections': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['structure.Section']", 'symmetrical': 'False'})
        },
        ...
        'video.video': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 3, 22, 57, 976334)'}),
