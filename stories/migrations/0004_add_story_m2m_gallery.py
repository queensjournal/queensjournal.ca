...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('galleries', '0002_rename_gallery_story_to_story_old'),
    )

    def forwards(self, orm):
        # Adding M2M table for field galleries on 'Story'
        m2m_table_name = db.shorten_name(u'stories_story_galleries')
        ...
        db.create_unique(m2m_table_name, ['story_id', 'gallery_id'])


    def backwards(self, orm):
        # Removing M2M table for field galleries on 'Story'
        db.delete_table(db.shorten_name(u'stories_story_galleries'))
    ...
    models = {
        ...
        u'stories.photo': {
            ...
            'creation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 3, 0, 0)'}),
        ...
        u'stories.story': {
            ...
            'galleries': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['galleries.Gallery']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'stories.storyauthor': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['authors.Author']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
