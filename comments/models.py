...
class FreeComment(models.Model):
	...
	person_email = models.EmailField(_("person's e-mail address"))
	person_location = models.CharField(_("person's location"), max_length=50)
	submit_date = models.DateTimeField(_('date/time submitted'), auto_now_add=True)
	is_public = models.BooleanField(_('is public'))
	...
	def get_absolute_url(self):
		return "%s%s/c#%i" % (self.get_content_object().get_absolute_url(), self.get_content_object().get_comment_url_prefix(), self.id)
